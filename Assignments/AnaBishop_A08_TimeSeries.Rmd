...
>Answer: The trendline appears to be nearly horizontal, athough a slight decrease is visible. Therefore, though there does not seem to be a strong trend in the data, since the data oscillates back and forth at the same levels fairly regularly over the years, a slightly decreasing trend is visible.
...
> Answer: The results of this test were exactly the same as the previous test. 
